...
/**
 * A graph consisting of a set of vertices of type <code>V</code> set and a set of edges of type <code>E</code>. Edges
 * of this graph type have exactly two endpoints; whether these endpoints must be distinct depends on the
 * implementation.
 * <p>
 * This implementation is shamelessly copied from the Jung graph library which is used as the implementation for all the
...
public interface Graph<V extends Vertex, E extends Edge<V>> extends Serializable {
    ...
    /**
     * Returns a <code>Collection</code> view of the incoming edges incident to <code>vertex</code> in this graph.
    ...
    /**
     * Returns a <code>Collection</code> view of the outgoing edges incident to <code>vertex</code> in this graph.
    ...
    /**
     * Returns a <code>Collection</code> view of the predecessors of <code>vertex</code> in this graph. A predecessor of
     * <code>vertex</code> is defined as a vertex <code>v</code> which is connected to <code>vertex</code> by an edge
     * <code>e</code>, where <code>e</code> is an outgoing edge of <code>v</code> and an incoming edge of
     * <code>vertex</code>.
    ...
    /**
     * Returns a <code>Collection</code> view of the successors of <code>vertex</code> in this graph. A successor of
     * <code>vertex</code> is defined as a vertex <code>v</code> which is connected to <code>vertex</code> by an edge
     * <code>e</code>, where <code>e</code> is an incoming edge of <code>v</code> and an outgoing edge of
     * <code>vertex</code>.
     * @param vertex the vertex whose predecessors are to be returned
    ...
    /**
     * Returns the number of incoming edges incident to <code>vertex</code>. Equivalent to
    ...
    /**
     * Returns the number of outgoing edges incident to <code>vertex</code>. Equivalent to
    ...
    /**
     * Returns <code>true</code> if <code>v1</code> is a predecessor of <code>v2</code> in this graph. Equivalent to
    ...
    /**
     * Returns <code>true</code> if <code>v1</code> is a successor of <code>v2</code> in this graph. Equivalent to
    ...
    /**
     * Returns the number of predecessors that <code>vertex</code> has in this graph. Equivalent to
    ...
    /**
     * Returns the number of successors that <code>vertex</code> has in this graph. Equivalent to
    ...
    /**
     * If <code>directed_edge</code> is a directed edge in this graph, returns the source; otherwise returns
     * <code>null</code>. The source of a directed edge <code>d</code> is defined to be the vertex for which
     * <code>d</code> is an outgoing edge. <code>directed_edge</code> is guaranteed to be a directed edge if its
    ...
    /**
     * If <code>directed_edge</code> is a directed edge in this graph, returns the destination; otherwise returns
     * <code>null</code>. The destination of a directed edge <code>d</code> is defined to be the vertex incident to
     * <code>d</code> for which <code>d</code> is an incoming edge. <code>directed_edge</code> is guaranteed to be a
     ...
     * @return the destination of <code>directed_edge</code> if it is a directed edge in this graph, * * or
     *         <code>null</code> otherwise
     */
    V getDest(E directedEdge);

    /**
     * Returns <code>true</code> if <code>vertex</code> is the source of <code>edge</code>. Equivalent to
    ...
    /**
     * Returns <code>true</code> if <code>vertex</code> is the destination of <code>edge</code>. Equivalent to
    ...
    /**
     * Adds edge <code>e</code> to this graph such that it connects vertex <code>v1</code> to <code>v2</code>.
     * Equivalent to <code>addEdge(e, new Pair<V>(v1, v2))</code>. If this graph does not contain <code>v1</code>,
     ...
     * <code>e</code> will be the default for this graph. See <code>Hypergraph.addEdge()</code> for a listing of
     ...
     * Equivalent to <code>addEdge(e, new Pair<V>(v1, v2))</code>. If this graph does not contain <code>v1</code>,
     * <code>v2</code>, or both, implementations may choose to either silently add the vertices to the graph or throw an
     * <code>IllegalArgumentException</code>. If <code>edgeType</code> is not legal for this graph, this method will
     * throw <code>IllegalArgumentException</code>. See <code>Hypergraph.addEdge()</code> for a listing of possible
     * reasons for failure.
     * @param e        the edge to be added
     * @param v1       the first vertex to be connected
     * @param v2       the second vertex to be connected
    ...
    /**
     * Returns the vertex at the other end of <code>edge</code> from <code>vertex</code>. (That is, returns the vertex
     * incident to <code>edge</code> which is not <code>vertex</code>.)
     * @param vertex the vertex to be queried
     * @param edge   the edge to be queried
    ...
    /**
     * Returns a view of all vertices in this graph. In general, this obeys the <code>Collection</code> contract, and
     * therefore makes no guarantees about the ordering of the vertices within the set.
    ...
    /**
     * Returns a view of all edges in this graph. In general, this obeys the <code>Collection</code> contract, and
     * therefore makes no guarantees about the ordering of the edges within the set.
    ...
    /**
     * Removes <code>edge</code> from this graph. Fails if <code>edge</code> is null, or is otherwise not an element of
     * this graph.
    ...
    static final long serialVersionUID = -3328562280468085770L;
}
